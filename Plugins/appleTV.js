!function() {
    ...
    // ============================================================
    // ДОПОМІЖНА ФУНКЦІЯ ПЕРЕВІРКИ ЖИВОСТІ ЕЛЕМЕНТА
    // ============================================================
    function e(n) {
    ...
    // ============================================================
    function t() {
        console.log("Applecation", "v" + n);
        
        // Перевірка, чи це TV платформа
        if (Lampa.Platform.screen("tv")) {
            
            // ========================================================
            // ПЕРЕОПРЕДІЛЕННЯ API ТА ШАБЛОНІВ
            // ========================================================
            (function() {
                const n = Lampa.Api.sources.tmdb;
                const e = Lampa.Template.js;
                
                // Перевизначення шаблону для епізодів
                Lampa.Template.js = function(n, t) {
                    if ("full_episode" === n && t && (t.runtime > 0 ? t.time = Lampa.Utils.secondsToTimeHuman(60 * t.runtime).replace(/\./g, "") : t.time = "", t.air_date)) {
                        const n = new Date(t.air_date.replace(/-/g, "/"));
                        const e = n.getMonth() + 1;
                        const a = Lampa.Lang.translate("month_" + e + "_e");
                        const o = i("year_short");
                        t.date = n.getDate() + " " + a + " " + n.getFullYear() + o;
                    }
                    return e.call(Lampa.Template, n, t);
                };
                
                // Перевизначення API для зображень (якість постерів)
                const t = n.img;
                n.img = function(e, a) {
                    const i = Lampa.Storage.field("poster_size");
                    const o = Lampa.Storage.get("applecation_poster_quality", "medium");
                    const r = "string" == typeof a && -1 !== a.indexOf("_face");
                    const l = ["w92", "w154", "w185", "w342", "w500", "w780", "original", "w300", "w200"].includes(a) || r;
                    const s = ["w300", "w780", "w1280", "original"].includes(a) && !r;
                    let p = !1;
                    
                    // Логіка вибору якості для портретних зображень
                    if (l && ("low" === o ? (a = r ? "w276_and_h350_face" : "w300", p = !0) : "medium" === o ? (a = r ? "w600_and_h900_face" : "w780", p = !0) : "high" === o && (a = "original", p = !0)), s && ("low" === o || "medium" === o ? (a = "w1280", p = !0) : "high" === o && (a = "original", p = !0)), p || "w1280" !== a || (a = {
                        w200: "w780",
                        w300: "w1280",
                        w500: "original"
                    }[i] || "w1280"), p || "w300" !== a || (a = {
                        ...
                        w300: "w780",
                        w500: "w780"
                    }[i] || "w300"), p || "w276_and_h350_face" !== a || "w500" !== i || (a = "w600_and_h900_face"), t.call(n, e, a);
                };
                Lampa.Api.img = n.img;
            })();
            ...
            void 0 === Lampa.Storage.get("applecation_poster_quality") && Lampa.Storage.set("applecation_poster_quality", "medium");
            
            // Параметр: якість постера
            Lampa.SettingsApi.addParam({
                ...
                param: {
                    ...
                    type: "select",
                    values: {
                        low: "Низьке - 720p (HD): 1280 x 720",
                        medium: "Середнє - 1080p (HD): 1920 x 1080",
                        high: "Високе - 4320p (8K): 7680 x 4320"
                    },
                    default: "medium"
                },
                field: {
                    name: "Якість постера",
                    description: "Виберіть якість зображень постерів та фону"
                },
                onChange: function(n) {
            ...
            // Параметр: відображення рейтингів
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                field: {
                    name: i("show_ratings"),
                    description: i("show_ratings_desc")
                },
                onChange: function(n) {
                    n ? $("body").removeClass("applecation--hide-ratings") : $("body").addClass("applecation--hide-ratings");
                }
            });
            
            // Параметр: позиція рейтингів
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                    ...
                    type: "select",
                    values: {
                        card: i("position_card"),
                        corner: i("position_corner")
                    },
                    default: "card"
                },
                field: {
                    name: i("ratings_position"),
                    description: i("ratings_position_desc")
                },
                onChange: function(n) {
                    Lampa.Storage.set("applecation_ratings_position", n);
                    $("body").removeClass("applecation--ratings-card applecation--ratings-corner");
                    $("body").addClass("applecation--ratings-" + n);
                    l();
                    r();
                    Lampa.Activity.back();
                }
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: {
                    name: i("show_reactions"),
                    description: i("show_reactions_desc")
                }
            });
            
            // Параметр: перевернути список епізодів
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                field: {
                    name: i("reverse_episodes"),
                    description: i("reverse_episodes_desc")
                },
                onChange: function(n) {
                    Lampa.Storage.set("applecation_reverse_episodes", n);
                }
            });
            
            // Параметр: опис в оверлеї
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                field: {
                    name: i("description_overlay"),
                    description: i("description_overlay_desc")
                },
                onChange: function(n) {
                    Lampa.Storage.set("applecation_description_overlay", n);
                }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                field: {
                    name: i("settings_title_scaling")
                }
            });
            
            // Параметр: масштаб логотипу
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                field: {
                    name: i("logo_scale"),
                    description: i("logo_scale_desc")
                },
                onChange: function(n) {
                    Lampa.Storage.set("applecation_logo_scale", n);
                    o();
                }
            });
            
            // Параметр: масштаб тексту
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                field: {
                    name: i("text_scale"),
                    description: i("text_scale_desc")
                },
                onChange: function(n) {
                    Lampa.Storage.set("applecation_text_scale", n);
                    o();
                }
            });
            
            // Параметр: масштаб відступів
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                    ...
                    values: {
                        ...
                        100: i("scale_default"),
                        110: "110%", 120: "120%", 130: "130%", 140: "140%", 150: "150%",
                        160: "160%", 170: "170%", 180: "180%", 200: "200%", 250: "250%", 300: "300%"
                    },
                    default: "100"
                },
                field: {
                    name: i("spacing_scale"),
                    description: i("spacing_scale_desc")
                },
                onChange: function(n) {
                    Lampa.Storage.set("applecation_spacing_scale", n);
                    o();
                }
            });
            
            // Кнопка завантаження оновлень
            Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                field: {
                    name: "Завантажити оновлення"
                },
                onRender: function(n) {
                    try {
                        n.addClass("selector");
                        n.on("hover:enter", function() {
                            // Функція відкриття модального вікна з посиланням на Tvigl.info
                            !function() {
                                $(".applecation-modal").remove();
                                $('style[data-id="applecation_tvigl_modal_css"]').remove();
                                $("body").append('<style data-id="applecation_tvigl_modal_css">.applecation-modal{position:fixed;inset:0;z-index:10000;display:flex;align-items:center;justify-content:center}.applecation-modal__bg{position:absolute;inset:0;background:rgba(0,0,0,.6)}.applecation-modal__content{position:relative;max-width:80vw;background:#1b1b1b;color:#fff;padding:1.5em;border-radius:.8em;box-shadow:0 0 20px rgba(0,0,0,.5)}.applecation-modal__text{margin:0 0 1em 0;line-height:1.5}.applecation-modal__buttons{display:flex;gap:.8em;justify-content:flex-end}.applecation-modal__btn{padding:.6em 1.2em;border-radius:.4em;background:#2a2a2a}.applecation-modal__btn.selector.focus{background:#3a3a3a}</style>');
                                Lampa.Template.add("applecation_tvigl_modal", '<div class="applecation-modal"><div class="applecation-modal__bg"></div><div class="applecation-modal__content"><div class="applecation-modal__text">Для завантаження оновлення або пошуку інших корисних плагінів перейдіть на сайт Tvigl.info</div><div class="applecation-modal__buttons"><div class="applecation-modal__btn selector js-go">Перейти</div><div class="applecation-modal__btn selector js-close">Закрити</div></div></div></div>');
                                var n = $(Lampa.Template.get("applecation_tvigl_modal", {}, !0));
                                $("body").append(n);
                                var e = n.find(".js-go");
                                var t = n.find(".js-close");
                                ...
                                var a = {
                                    toggle: function() {
                                        ...
                                        Lampa.Controller.collectionFocus(e, n);
                                    },
                                    left: function() {
                                ...
                                Lampa.Controller.add("applecation_tvigl_modal", a);
                                Lampa.Controller.toggle("applecation_tvigl_modal");
                            }();
                        });
                        n.find(".settings-param__name").html("Завантажити оновлення");
                    } catch (n) {}
                }
            });
            
            // Застосування класів для рейтингів
            Lampa.Storage.get("applecation_show_ratings", !1) || $("body").addClass("applecation--hide-ratings");
            ...
            // ========================================================
            // СЛУХАЧ ПОДІЙ ДЛЯ КАРТКИ ФІЛЬМУ
            // ========================================================
            Lampa.Listener.follow("full", n => {
                
                // Обробка події "start" - видалення опису з оригінального шаблону
                if (Lampa.Storage.get("applecation_description_overlay", !0) && function(n) {
                    if ("start" === n.type && n.link) {
                        const e = n.link.rows;
                        const t = e.indexOf("description");
                        t > -1 && e.splice(t, 1);
                    }
                }(n), "complite" === n.type) {
                    
                    const a = n.object.activity;
                    const i = a.render();
                    i.addClass("applecation");
                    a.__destroyed = !1;
                    
                    // Збереження оригінального destroy
                    var t = a.destroy;
                    a.destroy = function() {
                        a.__destroyed = !0;
                        t && t.apply(a, arguments);
                    };
                    
                    // Додавання класу для високої якості постера
                    const o = Lampa.Storage.field("poster_size");
                    i.toggleClass("applecation--poster-high", "w500" === o);
                    
                    // Додавання оверлею для фону
                    (function(n) {
                        const e = n.render().find(".full-start__background");
                        e.length && !e.next(".applecation__overlay").length && e.after('<div class="full-start__background loaded applecation__overlay"></div>');
                    })(a);
                    
                    // Оновлення мета-інформації (тип, жанри, мережа)
                    (function(n) {
                        const t = n.data.movie;
                        const a = n.object.activity;
                        if (!t || !a) return;
                        
                        // Оновлення тексту мета-інформації
                        (function(n, e) {
                            const t = n.render().find(".applecation__meta-text");
                            const a = [];
                            
                            // Додавання типу (фільм/серіал)
                            a.push((function(n) {
                                const e = Lampa.Storage.get("language", "ru");
                                const t = !!n.name;
                                const a = {
                                    ru: t ? "Серіал" : "Фільм",
                                    en: t ? "TV Series" : "Movie",
                                    uk: t ? "Серіал" : "Фільм",
                                    be: t ? "Серыял" : "Фільм",
                                    bg: t ? "Сериал" : "Филм",
                                    cs: t ? "Seriál" : "Film",
                            ...
                            if (e.genres && e.genres.length) {
                                const n = e.genres.slice(0, 2).map(n => Lampa.Utils.capitalizeFirstLetter(n.name));
                                a.push(...n);
                            }
                            t.html(a.join(" · "));
                            
                            // Оновлення логотипу мережі
                            (function(n, e) {
                                const t = n.render().find(".applecation__network");
                                if (e.networks && e.networks.length) {
                                    const n = e.networks[0];
                                    if (n.logo_path) {
                                        const e = Lampa.Api.img(n.logo_path, "w200");
                                        return void t.html(`<img src="${e}" alt="${n.name}">`);
                                    }
                                }
                                if (e.production_companies && e.production_companies.length) {
                                    const n = e.production_companies[0];
                                    if (n.logo_path) {
                                        const e = Lampa.Api.img(n.logo_path, "w200");
                                        return void t.html(`<img src="${e}" alt="${n.name}">`);
                                    }
                        ...
                        // Оновлення опису
                        (function(n, e) {
                            const t = n.render().find(".applecation__description");
                            const a = n.render().find(".applecation__description-wrapper");
                            const i = e.overview || "";
                            const o = Lampa.Storage.get("applecation_description_overlay", !0);
                            t.text(i);
                            
                            if (o) {
                                // Додавання оверлею для опису
                                (function(n, e) {
                                    const t = e.overview || "";
                                    const a = e.title || e.name;
                                    if (!t) return;
                                    $(".applecation-description-overlay").remove();
                                    const i = (e.release_date || e.first_air_date || "") + "";
                                    const o = i.length > 3 ? Lampa.Utils.parseTime(i).full : i.length > 0 ? i : Lampa.Lang.translate("player_unknown");
                                    const r = "$ " + Lampa.Utils.numberWithSpaces(e.budget || 0);
                                    const l = (function(n) {
                                        return n.production_countries ? n.production_countries.map(n => {
                                            const e = "country_" + n.iso_3166_1.toLowerCase();
                                            const t = Lampa.Lang.translate(e);
                                            return t !== e ? t : n.name;
                                        }) : [];
                                    })(e);
                                    const s = l.join(", ");
                                    const p = $(Lampa.Template.get("applecation_overlay", {
                                        title: a,
                                        text: t,
                                        relise: o,
                                        budget: r,
                                    ...
                                    e.budget && 0 !== e.budget || p.find(".applecation--budget").remove();
                                    s || p.find(".applecation--countries").remove();
                                    $("body").append(p);
                                    p.data("controller-created", !1);
                                })(0, e);
                                
                                // Додавання обробника кліку на опис
                                a.off("hover:enter").on("hover:enter", function() {
                                    !function() {
                                        const n = $(".applecation-description-overlay");
                                        if (n.length) {
                                            if (setTimeout(() => n.addClass("show"), 10), !n.data("controller-created")) {
                                                const e = {
                                                    toggle: function() {
                                                        Lampa.Controller.collectionSet(n);
                                                        Lampa.Controller.collectionFocus(n.find(".applecation-description-overlay__content"), n);
                                                    },
                                                    back: function() {
                                                        !function() {
                                                            const n = $(".applecation-description-overlay");
                                                            n.length && (n.removeClass("show"), setTimeout(() => {
                                                                Lampa.Controller.toggle("content");
                                                            }, 300));
                                                        }();
                                                    }
                                                };
                                                Lampa.Controller.add("applecation_description", e);
                                                n.data("controller-created", !0);
                                            }
                        ...
                        // Оновлення додаткової інформації (рік, тривалість, сезони)
                        (function(n, e) {
                            const t = n.render().find(".applecation__info");
                            const a = [];
                            const i = e.release_date || e.first_air_date || "";
                            ...
                            if (e.name) {
                                // Для серіалів
                                if (e.episode_run_time && e.episode_run_time.length) {
                                    const n = e.episode_run_time[0];
                                    const t = Lampa.Lang.translate("time_m").replace(".", "");
                                    a.push(`${n} ${t}`);
                                }
                                const n = Lampa.Utils.countSeasons(e);
                                n && a.push((function(n) {
                                    const e = Lampa.Storage.get("language", "ru");
                                    if (["ru", "uk", "be", "bg"].includes(e)) {
                                        const t = [2, 0, 1, 1, 1, 2];
                                        const a = {
                                        ...
                                        return `${n} ${(a[e] || a.ru)[n % 100 > 4 && n % 100 < 20 ? 2 : t[Math.min(n % 10, 5)]]}`;
                                    }
                                    if ("en" === e) return 1 === n ? `${n} Season` : `${n} Seasons`;
                                    if ("cs" === e) return 1 === n || n >= 2 && n <= 4 ? `${n} série` : `${n} sérií`;
                                    if ("pt" === e) return 1 === n ? `${n} Temporada` : `${n} Temporadas`;
                                    if ("he" === e) return 1 === n ? `עונה ${n}` : `${n} עונות`;
                                    if ("zh" === e) return `${n} 季`;
                                    const t = Lampa.Lang.translate("full_season");
                                    return 1 === n ? `${n} ${t}` : `${n} ${t}s`;
                                })(n));
                            } else if (e.runtime && e.runtime > 0) {
                                // Для фільмів
                                const n = Math.floor(e.runtime / 60);
                                const t = e.runtime % 60;
                                const i = Lampa.Lang.translate("time_h").replace(".", "");
                                const o = Lampa.Lang.translate("time_m").replace(".", "");
                                const r = n > 0 ? `${n} ${i} ${t} ${o}` : `${t} ${o}`;
                                a.push(r);
                            }
                            
                            const o = a.length > 0 ? a.join(" · ") : "";
                            t.html(o + '<span class="applecation__quality-badges"></span>');
                        })(a, t);
                        
                        // Анімація появи елементів
                        s(a, () => {
                            if (!e(a)) return;
                            a.render().find(".applecation__meta").addClass("show");
                            const n = Lampa.Storage.get("applecation_description_overlay", !0);
                            const t = a.render().find(".applecation__description-wrapper").addClass("show");
                            if (n) {
                                t.addClass("selector");
                                window.Lampa && Lampa.Controller && Lampa.Controller.collectionAppend(t);
                            }
                            a.render().find(".applecation__info").addClass("show");
                            a.render().find(".applecation__ratings").addClass("show");
                        });
                        
                        // Завантаження логотипу
                        const i = t.name ? "tv" : "movie";
                        const o = Lampa.TMDB.api(`${i}/${t.id}/images?api_key=${Lampa.TMDB.key()}&language=${Lampa.Storage.get("language")}`);
                        
                        $.get(o, n => {
                            if (!e(a)) return;
                            const t = a.render().find(".applecation__logo");
                            const i = a.render().find(".full-start-new__title");
                            
                            if (n.logos && n.logos[0]) {
                                const i = n.logos[0].file_path;
                                const o = (function() {
                                    const n = Lampa.Storage.get("applecation_poster_quality", "medium");
                                    if ("low" === n) return "w300";
                                    if ("medium" === n) return "w500";
                                    if ("high" === n) return "original";
                                    return {
                                        w200: "w300",
                                        w300: "w500",
                                        w500: "original"
                                    }[Lampa.Storage.field("poster_size")] || "w500";
                                })();
                                const r = Lampa.TMDB.image(`/t/p/${o}${i}`);
                                const l = new Image;
                                l.onload = () => {
                                    e(a) && (t.html(`<img src="${r}" alt="" />`), s(a, () => {
                                        e(a) && t.addClass("loaded");
                                    }), (function(n) {
                                        const e = $(".applecation-description-overlay");
                                        if (e.length && n) {
                                            const t = $("<img>").attr("src", n);
                                            e.find(".applecation-description-overlay__logo").html(t).css("display", "block");
                                            e.find(".applecation-description-overlay__title").css("display", "none");
                                        }
                                    })(r));
                                };
                                l.src = r;
                            ...
                            a.render().find(".full-start-new__title").show();
                            s(a, () => {
                                a.render().find(".applecation__logo").addClass("loaded");
                            });
                        });
                    })(n);
                    
                    // Патч для ефекту розмиття при скролі
                    (function(n) {
                        const e = n.render().find(".full-start__background:not(.applecation__overlay)")[0];
                        const t = n.render().find(".scroll__body")[0];
                        if (!e || !t) return;
                        let a = !1;
                        const i = Object.getOwnPropertyDescriptor(t.style, "-webkit-transform") || Object.getOwnPropertyDescriptor(CSSStyleDeclaration.prototype, "webkitTransform");
                        Object.defineProperty(t.style, "-webkit-transform", {
                            set: function(n) {
                                if (n) {
                                    const t = n.indexOf(",") + 1;
                                    const i = n.indexOf(",", t);
                                    if (t > 0 && i > t) {
                                        const o = parseFloat(n.substring(t, i)) < 0;
                                        o !== a && (a = o, e.classList.toggle("dim", o));
                                    }
                                }
                                i && i.set ? i.set.call(this, n) : this.setProperty("-webkit-transform", n);
                            },
                            get: function() {
                                return i && i.get ? i.get.call(this) : this.getPropertyValue("-webkit-transform");
                            },
                            configurable: !0
                        });
                    })(a);
                    
                    // Анімація довгих імен акторів (біжучий рядок)
                    (function(n) {
                        const t = n.render().find(".full-person__name");
                        t.each(function() {
                            const n = $(this);
                            if (n.hasClass("marquee-processed")) {
                                const e = n.find("span").first().text();
                                e && (n.text(e), n.removeClass("marquee-processed marquee-active"), n.css("--marquee-duration", ""));
                            }
                        });
                        setTimeout(() => {
                            e(n) && t.each(function() {
                                ...
                                if (e) {
                                    if ((function(n) {
                                        ...
                                        const t = Math.min(Math.max(.25 * e.length, 5), 20);
                                        n.addClass("marquee-processed marquee-active");
                                        n.css("--marquee-duration", t + "s");
                                        const a = $("<span>").text(e);
                                        const i = $("<span>").text(e);
                                        const o = $('<div class="marquee__inner">').append(a).append(i);
                                        n.empty().append(o);
                                    } else {
                    ...
                    // ========================================================
                    // ВИЗНАЧЕННЯ ЯКОСТІ ВІДЕО (4K, HDR, Dolby Vision)
                    // ========================================================
                    const r = n.data;
                    const l = r && r.movie;
                    
                    if (l && (function(n, t) {
                        if (!n || !Lampa.Storage.field("parser_use")) return;
                        if (!Lampa.Parser || "function" != typeof Lampa.Parser.get) return;
                        
                        const a = n.title || n.name || "Невідомо";
                        const i = ((n.first_air_date || n.release_date || "0000") + "").slice(0, 4);
                        const o = {
                            df: n.original_title,
                            df_year: n.original_title + " " + i,
                            df_lg: n.original_title + " " + n.title,
                            df_lg_year: n.original_title + " " + n.title + " " + i,
                            lg: n.title,
                            lg_year: n.title + " " + i,
                            lg_df: n.title + " " + n.original_title,
                            lg_df_year: n.title + " " + n.original_title + " " + i
                        }[Lampa.Storage.field("parse_lang")] || n.title;
                        ...
                        Lampa.Parser.get({
                            ...
                            if (!e(t)) return;
                            if (!n || !n.Results || 0 === n.Results.length) return;
                            ...
                            // Парсинг результатів для визначення якості
                            n.Results.forEach(n => {
                                if (n.ffprobe && Array.isArray(n.ffprobe)) {
                                    const e = (function(n) {
                                        ...
                                        const t = n.find(n => "video" === n.codec_type);
                                        if (t) {
                                            // Визначення роздільної здатності
                                            if (t.width && t.height) {
                                                e.resolution = `${t.width}x${t.height}`;
                                                if (t.height >= 2160 || t.width >= 3840) e.resolutionLabel = "4K";
                                                else if (t.height >= 1440 || t.width >= 2560) e.resolutionLabel = "2K";
                                                else if (t.height >= 1080 || t.width >= 1920) e.resolutionLabel = "FULL HD";
                                                else if (t.height >= 720 || t.width >= 1280) e.resolutionLabel = "HD";
                                            }
                                            // Визначення HDR та Dolby Vision
                                            if (t.side_data_list) {
                                                const n = t.side_data_list.some(n => "Mastering display metadata" === n.side_data_type);
                                                const a = t.side_data_list.some(n => "Content light level metadata" === n.side_data_type);
                                                if (t.side_data_list.some(n => "DOVI configuration record" === n.side_data_type || "Dolby Vision RPU" === n.side_data_type)) {
                                                    e.dolbyVision = !0;
                                                    e.hdr = !0;
                                                } else if (n || a) {
                                                    e.hdr = !0;
                                            ...
                                            if (!e.hdr && t.color_transfer && ["smpte2084", "arib-std-b67"].includes(t.color_transfer.toLowerCase())) {
                                                e.hdr = !0;
                                            }
                                            if (!e.dolbyVision && t.codec_name && (t.codec_name.toLowerCase().includes("dovi") || t.codec_name.toLowerCase().includes("dolby"))) {
                                                e.dolbyVision = !0;
                                                e.hdr = !0;
                                            }
                                        }
                                        // Визначення аудіоформату
                                        const a = n.filter(n => "audio" === n.codec_type);
                                        let i = 0;
                                        a.forEach(n => {
                                            n.channels && n.channels > i && (i = n.channels);
                                        });
                                        if (i >= 8) e.audio = "7.1";
                                        else if (i >= 6) e.audio = "5.1";
                                        else if (i >= 4) e.audio = "4.0";
                                        else if (i >= 2) e.audio = "2.0";
                                        return e;
                                    })(n.ffprobe);
                                    
                                    if (e) {
                                        e.resolutionLabel && i.resolutions.add(e.resolutionLabel);
                                        e.audio && i.audio.add(e.audio);
                                    }
                                    
                                    // Перевірка на наявність дубляжу
                                    if (!i.hasDub) {
                                        n.ffprobe.filter(n => "audio" === n.codec_type && n.tags).forEach(n => {
                                            const e = (n.tags.language || "").toLowerCase();
                                            const t = (n.tags.title || n.tags.handler_name || "").toLowerCase();
                                            if (("rus" === e || "ru" === e || "russian" === e) && (t.includes("dub") || t.includes("дубляж") || t.includes("дублир") || "d" === t)) {
                                                i.hasDub = !0;
                                            }
                                        });
                                    }
                                ...
                                if (e.includes("dolby vision") || e.includes("dovi") || e.match(/\bdv\b/)) i.hdr.add("Dolby Vision");
                                if (e.includes("hdr10+")) i.hdr.add("HDR10+");
                                if (e.includes("hdr10")) i.hdr.add("HDR10");
                                if (e.includes("hdr")) i.hdr.add("HDR");
                            });
                            
                            // Формування об'єкта з інформацією про якість
                            const o = {
                                title: a,
                                torrents_found: n.Results.length,
                                quality: null,
                                dv: !1,
                                hdr: !1,
                                hdr_type: null,
                            ...
                            if (i.resolutions.size > 0) {
                                const n = ["8K", "4K", "2K", "FULL HD", "HD"];
                                for (const e of n) {
                                    if (i.resolutions.has(e)) {
                                        o.quality = e;
                                        break;
                                    }
                                }
                            ...
                            if (i.hdr.has("Dolby Vision") && (o.dv = !0, o.hdr = !0), i.hdr.size > 0) {
                                o.hdr = !0;
                                const n = ["HDR10+", "HDR10", "HDR"];
                                for (const e of n) {
                                    if (i.hdr.has(e)) {
                                        o.hdr_type = e;
                                        break;
            ...
            // ========================================================
            // ПАТЧ ДЛЯ ЗМІНИ ПОРЯДКУ ЕПІЗОДІВ
            // ========================================================
            (function() {
                try {
                    if (window.applecation_episodes_core_patch) return;
                    if (window.applecation_episodes_core_patch = !0, window.episodes_order_fix = !0, window.episodes_core_patch = !0, !window.Lampa || !Lampa.Utils || "function" != typeof Lampa.Utils.createInstance) return;
                    if (Lampa.Utils.__applecation_episodes_core_patch_applied) return;
                    
                    // Функція перевірки наявності даних про епізоди
                    function e(n) {
                        try {
                            if (!n) return !1;
                            if (!n.movie) return !1;
                            if (!Array.isArray(n.results) || !n.results.length) return !1;
                            for (var e = 0, t = 0; t < n.results.length; t++) {
                                var a = n.results[t];
                                a && ("number" == typeof a.episode_number && e++, "number" == typeof a.season_number && e++, a.comeing && e++, a.air_date && e++);
                            }
                            return e >= 3;
                        } catch (n) {
                            return !1;
                    ...
                    // Функція зміни порядку епізодів (реверс)
                    function t(n) {
                        const e = n;
                        try {
                            for (var t = e.results || [], a = [], i = [], o = 0; o < t.length; o++) {
                                var r = t[o];
                                r && (r.comeing ? a.push(r) : i.push(r));
                            }
                            i.sort(function(n, e) {
                                return (n.episode_number || 0) - (e.episode_number || 0);
                            });
                            e.results = i.concat(a);
                        } catch (e) {}
                    }
                    
                    // Патч для додавання елемента "card-more"
                    function a(n) {
                        try {
                            if (!n || !n.scroll || "function" != typeof n.scroll.append) return;
                            if (n.__applecation_episodes_scroll_append_patched) return;
                            n.__applecation_episodes_scroll_append_patched = !0;
                            var e = n.scroll.append.bind(n.scroll);
                            n.scroll.append = function(t) {
                                var a = t instanceof jQuery ? t[0] : t;
                                if (a && a.classList && a.classList.contains("card-more")) return e(t);
                                var i = "function" == typeof n.scroll.body ? n.scroll.body(!0) : null;
                                if (i) {
                                    var o = i.querySelector(".card-more");
                                    if (o && a && a !== o) return void i.insertBefore(a, o);
                                }
                                return e(t);
                            };
                        } catch (n) {}
                    ...
                    // Патч для методу create
                    function i(n) {
                        try {
                            if (!n || "function" != typeof n.create) return;
                            if (n.__applecation_episodes_create_patched) return;
                            n.__applecation_episodes_create_patched = !0;
                            var e = n.create.bind(n);
                            n.create = function() {
                                a(n);
                                var t = e();
                                setTimeout(function() {
                                    try {
                                        var e = n && n.scroll && "function" == typeof n.scroll.body ? n.scroll.body(!0) : null;
                                        var t = e ? e.querySelector(".card-more") : null;
                                        t && t.classList.remove("card-more--first");
                                    } catch (n) {}
                                }, 0);
                                return t;
                            };
                    ...
                    Lampa.Utils.__applecation_episodes_core_patch_applied = !0;
                    var n = Lampa.Utils.createInstance;
                    Lampa.Utils.createInstance = function(a, o, r, l) {
                        var s = e(o);
                        var p = Lampa.Storage.get("applecation_reverse_episodes", !0);
                        if (s && p) t(o);
                        var c = n.call(this, a, o, r, l);
                        if (s && p) i(c);
                        return c;
                    };
                } catch (o) {}
    ...
    // ============================================================
    function s(n, t) {
        const a = n.render().find(".full-start__background:not(.applecation__overlay)");
        if (!a.length) return void t();
        if (a.hasClass("loaded") && a.hasClass("applecation-animated")) return void t();
        if (a.hasClass("loaded")) return void setTimeout(() => {
            a.addClass("applecation-animated");
            t();
        }, 350);
        ...
        setTimeout(() => {
            clearInterval(i);
            if (!a.hasClass("applecation-animated")) {
                a.addClass("applecation-animated");
                t();
            }
        }, 2000);

!function() {
    ...
    function t() {
        console.log("Applecation", "v" + n), Lampa.Platform.screen("tv") ? (function() {
            ...
            Lampa.Template.js = function(n, t) {
                if ("full_episode" === n && t && (t.runtime > 0 ? t.time = Lampa.Utils.secondsToTimeHuman(60 * t.runtime).replace(/\./g, "") : t.time = "", t.air_date)) {
                    const n = new Date(t.air_date.replace(/-/g, "/")),
                        e = n.getMonth() + 1,
                        a = Lampa.Lang.translate("month_" + e + "_e"),
                        o = i("year_short");
            ...
            n.img = function(e, a) {
                const i = Lampa.Storage.field("poster_size"),
                    o = Lampa.Storage.get("applecation_poster_quality", "medium"),
                    r = "string" == typeof a && -1 !== a.indexOf("_face"),
                    l = ["w92", "w154", "w185", "w342", "w500", "w780", "original", "w300", "w200"].includes(a) || r,
                    s = ["w300", "w780", "w1280", "original"].includes(a) && !r;
                let p = !1;
                return l && ("low" === o ? (a = r ? "w276_and_h350_face" : "w300", p = !0) : "medium" === o ? (a = r ? "w600_and_h900_face" : "w780", p = !0) : "high" === o && (a = "original", p = !0)), s && ("low" === o || "medium" === o ? (a = "w1280", p = !0) : "high" === o && (a = "original", p = !0)), p || "w1280" !== a || (a = {
                    w200: "w780",
                    w300: "w1280",
                    w500: "original"
                } [i] || "w1280"), p || "w300" !== a || (a = {
            ...
            }), void 0 === Lampa.Storage.get("applecation_poster_quality") && Lampa.Storage.set("applecation_poster_quality", "medium"), Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                onChange: function(n) {
                    Lampa.Storage.set("applecation_ratings_position", n), $("body").removeClass("applecation--ratings-card applecation--ratings-corner"), $("body").addClass("applecation--ratings-" + n), l(), r(), Lampa.Activity.back()
                }
            }), Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                onChange: function(n) {
                    Lampa.Storage.set("applecation_logo_scale", n), o()
                }
            }), Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                onChange: function(n) {
                    Lampa.Storage.set("applecation_text_scale", n), o()
                }
            }), Lampa.SettingsApi.addParam({
                component: "applecation_settings",
                param: {
                ...
                if (Lampa.Storage.get("applecation_description_overlay", !0) && function(n) {
                        if ("start" === n.type && n.link) {
                            const e = n.link.rows,
                                t = e.indexOf("description");
                            t > -1 && e.splice(t, 1)
                        }
                    }(n), "complite" === n.type) {
                    const a = n.object.activity,
                        i = a.render();
                    i.addClass("applecation"), a.__destroyed = !1;
                    var t = a.destroy;
                    a.destroy = function() {
                        a.__destroyed = !0, t && t.apply(a, arguments)
                    };
                    const o = Lampa.Storage.field("poster_size");
                    i.toggleClass("applecation--poster-high", "w500" === o), function(n) {
                        ...
                        (function(n, e) {
                            ...
                            a.push(r(e)), e.genres && e.genres.length && (e.genres.slice(0, 2).map(n => Lampa.Utils.capitalizeFirstLetter(n.name)), a.push(...e.genres.slice(0, 2).map(n => Lampa.Utils.capitalizeFirstLetter(n.name)))), t.html(a.join(" · ")), function(n, e) {
                            ...
                            const t = n.render().find(".applecation__description"),
                                a = n.render().find(".applecation__description-wrapper"),
                                i = e.overview || "",
                                o = Lampa.Storage.get("applecation_description_overlay", !0);
                            t.text(i), o ? (function(n, e) {
                                const t = e.overview || "",
                                    a = e.title || e.name;
                                if (!t) return;
                                $(".applecation-description-overlay").remove();
                                const i = (e.release_date || e.first_air_date || "") + "",
                                    o = i.length > 3 ? Lampa.Utils.parseTime(i).full : i.length > 0 ? i : Lampa.Lang.translate("player_unknown"),
                                    r = "$ " + Lampa.Utils.numberWithSpaces(e.budget || 0),
                                    l = function(n) {
                                        return n.production_countries ? n.production_countries.map(n => {
                                            const e = "country_" + n.iso_3166_1.toLowerCase(),
                                                t = Lampa.Lang.translate(e);
                                            return t !== e ? t : n.name
                                        }) : []
                                    }(e),
                                    s = l.join(", "),
                                    p = $(Lampa.Template.get("applecation_overlay", {
                                        title: a,
                                        text: t,
                                        relise: o,
                                        budget: r,
                                ...
                                e.budget && 0 !== e.budget || p.find(".applecation--budget").remove(), s || p.find(".applecation--countries").remove(), $("body").append(p), p.data("controller-created", !1)
                            })(0, e), a.off("hover:enter").on("hover:enter", function() {
                                ! function() {
                                    ...
                                    if (n.length) {
                                        if (setTimeout(() => n.addClass("show"), 10), !n.data("controller-created")) {
                                            const e = {
                                                toggle: function() {
                                                    Lampa.Controller.collectionSet(n), Lampa.Controller.collectionFocus(n.find(".applecation-description-overlay__content"), n)
                                                },
                                                back: function() {
                                                    ! function() {
                                                        const n = $(".applecation-description-overlay");
                                            ...
                                            Lampa.Controller.add("applecation_description", e), n.data("controller-created", !0)
                                        }
                                        Lampa.Controller.toggle("applecation_description")
                                    }
                                }()
                            })) : (a.off("hover:enter"), $(".applecation-description-overlay").remove())
                        }(a, t), function(n, e) {
                            const t = n.render().find(".applecation__info"),
                                a = [],
                                i = e.release_date || e.first_air_date || "";
                            if (i) {
                                const n = i.split("-")[0];
                                a.push(n)
                            }
                            if (e.name) {
                                if (e.episode_run_time && e.episode_run_time.length) {
                                    const n = e.episode_run_time[0],
                                        t = Lampa.Lang.translate("time_m").replace(".", "");
                                    a.push(`${n} ${t}`)
                                }
                                ...
                                const n = Math.floor(e.runtime / 60),
                                    t = e.runtime % 60,
                                    i = Lampa.Lang.translate("time_h").replace(".", ""),
                                    o = Lampa.Lang.translate("time_m").replace(".", ""),
                                    r = n > 0 ? `${n} ${i} ${t} ${o}` : `${t} ${o}`;
                                a.push(r)
                            }
                            ...
                            const n = Lampa.Storage.get("applecation_description_overlay", !0),
                                t = a.render().find(".applecation__description-wrapper").addClass("show");
                            n && (t.addClass("selector"), window.Lampa && Lampa.Controller && Lampa.Controller.collectionAppend(t)), a.render().find(".applecation__info").addClass("show"), a.render().find(".applecation__ratings").addClass("show")
                        });
                        const i = t.name ? "tv" : "movie",
                            o = Lampa.TMDB.api(`${i}/${t.id}/images?api_key=${Lampa.TMDB.key()}&language=${Lampa.Storage.get("language")}`);
                        $.get(o, n => {
                            if (!e(a)) return;
                            const t = a.render().find(".applecation__logo"),
                                i = a.render().find(".full-start-new__title");
                                ...
                                l.onload = () => {
                                    e(a) && (t.html(`<img src="${r}" alt="" />`), s(a, () => {
                                        ...
                                        if (e.length && n) {
                                            ...
                                            e.find(".applecation-description-overlay__logo").html(t).css("display", "block"), e.find(".applecation-description-overlay__title").css("display", "none")
                                        }
                                    }(r))
                                }, l.src = r
                            } else i.show(), s(a, () => {
                            ...
                            e(n) && t.each(function() {
                                ...
                                if (t)
                                    if (function(n) {
                                        ...
                                        const e = Math.min(Math.max(.25 * t.length, 5), 20);
                                        n.addClass("marquee-processed marquee-active"), n.css("--marquee-duration", e + "s");
                                        const a = $("<span>").text(t),
                                            i = $("<span>").text(t),
                                            o = $('<div class="marquee__inner">').append(a).append(i);
                                        n.empty().append(o)
                                    } else n.addClass("marquee-processed")
                            })
                        }, 100)
                    }(a);
                    const r = n.data,
                    ...
                    l && function(n, t) {
                        ...
                        const a = n.title || n.name || "Неизвестно",
                            i = ((n.first_air_date || n.release_date || "0000") + "").slice(0, 4),
                            o = {
                                df: n.original_title,
                            ...
                            n.Results.forEach(n => {
                                if (n.ffprobe && Array.isArray(n.ffprobe)) {
                                    const e = function(n) {
                                        ...
                                        if (t) {
                                            if (t.width && t.height && (e.resolution = `${t.width}x${t.height}`, t.height >= 2160 || t.width >= 3840 ? e.resolutionLabel = "4K" : t.height >= 1440 || t.width >= 2560 ? e.resolutionLabel = "2K" : t.height >= 1080 || t.width >= 1920 ? e.resolutionLabel = "FULL HD" : (t.height >= 720 || t.width >= 1280) && (e.resolutionLabel = "HD")), t.side_data_list) {
                                                const n = t.side_data_list.some(n => "Mastering display metadata" === n.side_data_type),
                                                    a = t.side_data_list.some(n => "Content light level metadata" === n.side_data_type);
                                                t.side_data_list.some(n => "DOVI configuration record" === n.side_data_type || "Dolby Vision RPU" === n.side_data_type) ? (e.dolbyVision = !0, e.hdr = !0) : (n || a) && (e.hdr = !0)
                                            }
                                            !e.hdr && t.color_transfer && ["smpte2084", "arib-std-b67"].includes(t.color_transfer.toLowerCase()) && (e.hdr = !0), !e.dolbyVision && t.codec_name && (t.codec_name.toLowerCase().includes("dovi") || t.codec_name.toLowerCase().includes("dolby")) && (e.dolbyVision = !0, e.hdr = !0)
                                        }
                                        const a = n.filter(n => "audio" === n.codec_type);
                                        let i = 0;
                                        return a.forEach(n => {
                                            n.channels && n.channels > i && (i = n.channels)
                                        }), i >= 8 ? e.audio = "7.1" : i >= 6 ? e.audio = "5.1" : i >= 4 ? e.audio = "4.0" : i >= 2 && (e.audio = "2.0"), e
                                    }(n.ffprobe);
                                    e && (e.resolutionLabel && i.resolutions.add(e.resolutionLabel), e.audio && i.audio.add(e.audio)), i.hasDub || n.ffprobe.filter(n => "audio" === n.codec_type && n.tags).forEach(n => {
                                        const e = (n.tags.language || "").toLowerCase(),
                                            t = (n.tags.title || n.tags.handler_name || "").toLowerCase();
                                        ("rus" !== e && "ru" !== e && "russian" !== e) || (t.includes("dub") || t.includes("дубляж") || t.includes("дублир") || "d" === t) && (i.hasDub = !0)
                                    })
                                }
                                const e = n.Title.toLowerCase();
                                (e.includes("dolby vision") || e.includes("dovi") || e.match(/\bdv\b/)) && i.hdr.add("Dolby Vision"), e.includes("hdr10+") && i.hdr.add("HDR10+"), e.includes("hdr10") && i.hdr.add("HDR10"), e.includes("hdr") && i.hdr.add("HDR")
                            });
                            const o = {
                                title: a,
                ...
                try {
                                ...
                                return setTimeout(function() {
                                    try {
                                        var e = n && n.scroll && "function" == typeof n.scroll.body ? n.scroll.body(!0) : null,
                                            t = e ? e.querySelector(".card-more") : null;
                    ...
                    Lampa.Utils.createInstance = function(a, o, r, l) {
                        var s = e(o),
                            p = Lampa.Storage.get("applecation_reverse_episodes", !0);
                        s && p && t(o);
    ...
    function s(n, t) {
        ...
        if (a.hasClass("loaded")) return void setTimeout(() => {
            a.addClass("applecation-animated"), t()
        }, 350);
        const i = setInterval(() => {
            e(n) ? a.hasClass("loaded") && (clearInterval(i), setTimeout(() => {
                e(n) && (a.addClass("applecation-animated"), t())
            }, 650)) : clearInterval(i)
        }, 50);
        setTimeout(() => {
            clearInterval(i), a.hasClass("applecation-animated") || (a.addClass("applecation-animated"), t())
        }, 2e3)
    }
    var p = {
        type: "other",
    ...
    Lampa.Manifest && Lampa.Manifest.plugins && (Lampa.Manifest.plugins = p), window.appready ? t() : Lampa.Listener.follow("app", n => {
        "ready" === n.type && t()
    })
}();